...
from recommender.save_embeddings import calculate_doc2vec_vectors
...
class JobRunner:
    ...
    def save_embeddings(self, doc2vec_path, vectors_path):
        """
        ...
        calculate_doc2vec_vectors(doc2vec_path, vectors_path)
