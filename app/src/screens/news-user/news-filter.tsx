      ...
      >
        <View style={styles.filterHeader}>
          <MaterialCommunityIcons
            name={expanded ? "close" : "filter"}
            size={24}
            color={theme.colors.textSemiLight}
          />
          <Text
          ...
          >
            {expanded ? "Zavřít filtry" : "Filtrovat"}
          </Text>
        </View>
      </TouchableWithoutFeedback>

      <Animated.View
        style={{ height: animationHeight, opacity: animationOpacity }}
      >
